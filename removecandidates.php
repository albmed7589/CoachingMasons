...
<div>
	...
	<div class="container">
	<form method='post' action='actions/docandidateremoval.php'>
			<?php
				...
				echo "<table>\r\n";
				echo "<tr><th>Candidate Name</th><th>Email</th><th>Phone Number</th><th>Coach</th><th>Last Contacted</th><th>Contacted By</th><th>Remove</th></tr>\r\n";
				...
				foreach ($data as $row) 
				{
					...
					echo "<td>" . "<input type='checkbox' name='delete[]' value='" . $row['CandidateID'] . "' >" . "</td>";
					echo "</tr>\r\n";
